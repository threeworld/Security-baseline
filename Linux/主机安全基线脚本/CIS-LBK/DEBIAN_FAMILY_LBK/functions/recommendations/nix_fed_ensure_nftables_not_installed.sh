...
# ~/CIS-LBK/functions/recommendations/nix_fed_ensure_nftables_not_installed.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/06/20    Recommendation "Ensure nftables is not installed"
# 
fed_ensure_nftables_not_installed()
{
