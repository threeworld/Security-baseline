...
# Eric Pinnell       12/01/20    Modified "Updated to account for systems where the module isn't present on the system"
# Eric Pinnell       12/01/20    Modified "Changed to not require external functions"
#
