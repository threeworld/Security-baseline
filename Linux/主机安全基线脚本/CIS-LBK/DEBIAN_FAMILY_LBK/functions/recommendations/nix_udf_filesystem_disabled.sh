...
# ~/CIS-LBK/functions/recommendations/nix_udf_filesystem_disabled.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       12/01/20    Recommendation "Ensure mounting of udf filesystems is disabled"
#

udf_filesystem_disabled()
{
