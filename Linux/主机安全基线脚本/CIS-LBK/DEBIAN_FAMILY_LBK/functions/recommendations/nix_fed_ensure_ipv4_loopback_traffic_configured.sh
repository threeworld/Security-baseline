...
# ~/CIS-LBK/functions/recommendations/nix_fed_ensure_ipv4_loopback_traffic_configured.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       10/08/20    Recommendation "Ensure loopback traffic is configured"
# 
fed_ensure_ipv4_loopback_traffic_configured()
{
