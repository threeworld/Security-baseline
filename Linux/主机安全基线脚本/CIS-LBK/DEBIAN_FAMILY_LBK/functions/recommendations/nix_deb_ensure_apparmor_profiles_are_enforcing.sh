...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_apparmor_profiles_are_enforcing.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/23/20    Recommendation "Ensure all AppArmor Profiles are enforcing"
# 
deb_ensure_apparmor_profiles_are_enforcing()
{
