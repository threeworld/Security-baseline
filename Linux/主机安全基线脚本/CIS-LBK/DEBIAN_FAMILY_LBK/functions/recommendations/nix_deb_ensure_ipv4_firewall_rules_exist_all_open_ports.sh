...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_ipv4_firewall_rules_exist_all_open_ports.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/20/20    Recommendation "Ensure firewall rules exist for all open ports"
# 
deb_ensure_ipv4_firewall_rules_exist_all_open_ports()
{
