...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_ipv6_default_deny_firewall_policy.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/20/20    Recommendation "Ensure IPv6 default deny firewall policy"
# 
deb_ensure_ipv6_default_deny_firewall_policy()
{
