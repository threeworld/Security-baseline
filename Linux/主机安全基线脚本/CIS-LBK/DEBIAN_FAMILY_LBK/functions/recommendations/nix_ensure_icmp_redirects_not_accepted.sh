...
ensure_icmp_redirects_not_accepted()
{
	...
	# Check net.ipv4.conf.all.accept_redirects in the running config
	syspar="net.ipv4.conf.all.accept_redirects"
	regpar="net\.ipv4\.conf\.all\.accept_redirects"
	spv="0"
	src4_chk_fix
	test1=$t1
	# Check net.ipv4.conf.all.accept_redirects in sysctl conf files
	spif_chk_fix
	test2=$t1

	# Check net.ipv4.conf.default.accept_redirects
	# Check net.ipv4.conf.default.accept_redirects in the running config
	syspar="net.ipv4.conf.default.accept_redirects"
	regpar="net\.ipv4\.conf\.default\.accept_redirects"
	spv="0"
	src4_chk_fix
	test3=$t1
	# Check net.ipv4.conf.default.accept_redirects in sysctl conf files
	spif_chk_fix
	test4=$t1
	...
	if [ "$no_ipv6" = yes ]; then
		...
		# Check net.ipv6.conf.all.accept_redirects in the running config
		syspar="net.ipv6.conf.all.accept_redirects"
		regpar="net\.ipv6\.conf\.all\.accept_redirects"
		spv="0"
		src6_chk_fix
		test5=$t1
		# Check net.ipv6.conf.all.accept_redirects in sysctl conf files
		spif_chk_fix
		test6=$t1

		# Check net.ipv6.conf.default.accept_redirects
		# Check net.ipv6.conf.default.accept_redirects in the running config
		syspar="net.ipv6.conf.default.accept_redirects"
		regpar="net\.ipv6\.conf\.default\.accept_redirects"
		spv="0"
		src6_chk_fix
		test7=$t1
		# Check net.ipv6.conf.default.accept_redirects in sysctl conf files
		spif_chk_fix
		test8=$t1
	fi
	# Check Test status
