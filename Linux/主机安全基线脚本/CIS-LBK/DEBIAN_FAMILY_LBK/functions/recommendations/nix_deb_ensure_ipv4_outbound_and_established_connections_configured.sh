...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_ipv4_outbound_and_established_connections_configured.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       10/08/20    Recommendation "Ensure outbound and established connections are configured"
# 
deb_ensure_ipv4_outbound_and_established_connections_configured()
{
