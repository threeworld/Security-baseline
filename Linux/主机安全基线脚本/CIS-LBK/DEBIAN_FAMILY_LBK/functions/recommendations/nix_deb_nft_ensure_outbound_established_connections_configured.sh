...
# ~/CIS-LBK/functions/recommendations/nix_deb_nft_ensure_outbound_established_connections_configured.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       10/07/20    Recommendation "Ensure outbound and established connections are configured"
# 
deb_nft_ensure_outbound_established_connections_configured()
{
