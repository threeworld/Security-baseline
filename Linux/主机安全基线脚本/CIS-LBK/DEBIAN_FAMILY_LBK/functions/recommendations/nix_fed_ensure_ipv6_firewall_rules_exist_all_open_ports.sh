...
# ~/CIS-LBK/functions/recommendations/nix_fed_ensure_ipv6_firewall_rules_exist_all_open_ports.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       10/08/20    Recommendation "Ensure IPv6 firewall rules exist for all open ports"
# 
fed_ensure_ipv6_firewall_rules_exist_all_open_ports()
{
